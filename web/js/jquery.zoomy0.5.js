...
jQuery.fn.zoomy = function (options) {
    ...
    function zoomParams(ele, zoom) {
        ...
        if (options.round === true) {
            zoom.css({
                ...
                '-webkit-border-radius': options.zoomSize / 2 + 'px',
                '-moz-border-radius': options.zoomSize / 2 + 'px',
                'border-radius': options.zoomSize / 2 + 'px'
            });
        } else {
            zoom.css({
                height: options.zoomSize,
                width: options.zoomSize
            }).children('span').css({height: options.zoomSize - 20, width: options.zoomSize - 20});
        }
    ...
    function setGlare(zoom) {
        ...
        if (options.round === true) {
            glare.css({
                height: options.zoomSize - 20,
                width: options.zoomSize - 20,
                '-webkit-border-radius': options.zoomSize / 2 + 'px',
                '-moz-border-radius': options.zoomSize / 2 + 'px',
                'border-radius': options.zoomSize / 2 + 'px'
            })
