...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#tab'
            //返回一个json字符串
            , url: '<%=request.getContextPath()%>/UserServlet?action=findAll'
            , toolbar: '#toolbarDemo'
            , title: '会员详情'
            , cols: [[
                {type: 'checkbox', fixed: 'left'}
                , {field: 'id', title: '会员ID', width: '15%', fixed: 'left', sort: true}
                , {field: 'userName', title: '会员用户名', width: '15%', sort: true}
                , {field: 'password', title: '密码', width: '20%'}
                , {field: 'phone', title: '联系方式', width: '21%'}
                , {field: 'college', title: '大学', width: '25%'}
                , {field: 'addr', title: '地址', width: '25%'}
